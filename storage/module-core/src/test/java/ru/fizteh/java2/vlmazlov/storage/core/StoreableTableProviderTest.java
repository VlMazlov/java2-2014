...
public class StoreableTableProviderTest {
    ...
    public void deserializeValidity() throws IOException, ParseException {
        ...
        Assert.assertEquals("deserialized value is incorrect", row.getDoubleAt(0), (Double) 1.54);
        Assert.assertEquals("deserialized value is incorrect", row.getIntAt(1), (Integer) 123412);
