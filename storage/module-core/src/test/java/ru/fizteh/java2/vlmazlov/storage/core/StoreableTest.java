...
public class StoreableTest {
    ...
    public void validColumnGetInt() {
        Assert.assertEquals(row.getIntAt(1), (Integer) 12312);
    }

    @Test
    public void validColumnGetLong() {
        Assert.assertEquals(row.getLongAt(4), (Long) 12432131241244L);
    }

    @Test
    public void validColumnGetByte() {
        Assert.assertEquals(row.getByteAt(5), Byte.valueOf((byte) -89));
    }

    @Test
    public void validColumnGetDouble() {
        Assert.assertEquals(row.getDoubleAt(0), (Double) 1.54);
    }

    @Test
    public void validColumnGetFloat() {
        Assert.assertEquals(row.getFloatAt(3), (Float) 1.2f);
    }
